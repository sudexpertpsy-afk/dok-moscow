...
INITIAL_REGISTRY: list[dict] = [
    ...
    },
    {
        ...
        "sort_order": 80,
        "tracked_articles": [],
        "notes": "Полный текст из ИПС (судебно-психиатрический профиль)",
        "ips_nd": "102017214",
        "eo_number": None,
        "watch_enabled": True,
    ...
    },
    {
        ...
        "notes": "Медицинская и судебно-медицинская экспертиза; фрагменты из ИПС",
        "ips_nd": "102152259",
        "eo_number": "0001201111220007",
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 100,
        "tracked_articles": [],
        "notes": "Текст подтягивается по seed_url; первоисточник — Пленум ВС РФ",
        "ips_nd": None,
        "eo_number": None,
        "seed_url": (
            "https://rulaws.ru/vs_rf/"
            "Postanovlenie-Plenuma-Verhovnogo-Suda-RF-ot-21.12.2010-N-28/"
        ),
        "watch_enabled": False,
        "watch_name": None,
    },
    {
        ...
        "sort_order": 110,
        "tracked_articles": [],
        "notes": "Действует в части; текст по seed_url (Пленум ВАС РФ)",
        "ips_nd": None,
        "eo_number": None,
        "seed_url": "https://www.consultant.ru/document/cons_doc_LAW_162155/",
        "watch_enabled": False,
        "watch_name": None,
    },
    {
        ...
        "sort_order": 120,
        "tracked_articles": [],
        "notes": "PDF с publication.pravo.gov.ru (eoNumber)",
        "ips_nd": None,
        "eo_number": "0001201703030019",
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 130,
        "tracked_articles": [],
        "notes": "Текст по seed_url; проверить действующий статус при вычитке",
        "ips_nd": None,
        "eo_number": None,
        "seed_url": (
            "https://rulaws.ru/acts/"
            "Prikaz-Minzdravsotsrazvitiya-RF-ot-12.05.2010-N-346n/"
        ),
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 140,
        "tracked_articles": [],
        "notes": "Сводная карточка: перечень видов / аттестация — ссылка на minjust.gov.ru",
        "ips_nd": None,
        "eo_number": None,
        "seed_link_card": True,
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 150,
        "tracked_articles": [],
        "notes": "Исходный приказ 2005 в publication API не найден — карточка со ссылкой",
        "ips_nd": None,
        "eo_number": None,
        "seed_link_card": True,
        "watch_enabled": True,
...
def ensure_legal_registry(db: Session) -> list[LegalAct]:
    ...
    for row in INITIAL_REGISTRY:
        ...
        if "eo_number" in row:
            payload["eo_number"] = row.get("eo_number")
        if act is None:
