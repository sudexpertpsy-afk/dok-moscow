...
INITIAL_REGISTRY: list[dict] = [
    ...
    },
    {
        ...
        "sort_order": 100,
        "tracked_articles": [],
        "notes": "Ручная загрузка с vsrf.ru (нет ips_nd / eo в publication API)",
        "ips_nd": None,
        "eo_number": None,
        "watch_enabled": False,
        "watch_name": None,
    },
    {
        ...
        "sort_order": 110,
        "tracked_articles": [],
        "notes": "Действует в части; ручная загрузка (нет стабильного API текста)",
        "ips_nd": None,
        "eo_number": None,
        "watch_enabled": False,
        "watch_name": None,
    ...
    },
    {
        ...
        "sort_order": 130,
        "tracked_articles": [],
        "notes": "В publication API исходный PDF не найден — ручная загрузка; проверить действующий статус",
        "ips_nd": None,
        "eo_number": None,
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 140,
        "tracked_articles": [],
        "notes": "Сводная карточка: перечень видов / аттестация — ручная загрузка с minjust.gov.ru",
        "ips_nd": None,
        "eo_number": None,
        "watch_enabled": True,
    ...
    },
    {
        ...
        "sort_order": 150,
        "tracked_articles": [],
        "notes": "Исходный приказ 2005 в API не найден (есть только изменения) — ручная загрузка",
        "ips_nd": None,
        "eo_number": None,
        "watch_enabled": True,
